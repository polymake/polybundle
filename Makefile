...
.PHONY: all skeleton boost ppl gcc rpath perl gmp readline mpfr ant polymake-prepare polymake-compile dmg clean clean-install polymake-install polymake-docs relative-paths doc polymake-executable
...
skeleton : 
	...
	@install -m 550 scripts/polymake.start polymake.app/Contents/MacOS/
...
polymake-prepare : 
	@cd $(TMP); mkdir -p polymake-beta; cd polymake-beta; svn checkout --username "guest" --password "" http://polymake.mathematik.tu-darmstadt.de/svn/polymake/snapshots/latest/ .
